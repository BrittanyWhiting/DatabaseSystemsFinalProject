...
(
        Tvname VARCHAR2(60),
        Tvrating VARCHAR2(10),
        Tvimdb NUMBER(2), 
        Tvdate DATE,
        Tvdescription VARCHAR2(300),
...
INSERT INTO movi
VALUES('Schindlers List','In German-occupied Poland during World War II, industrialist Oskar Schindler gradually becomes concerned for his Jewish workforce after witnessing their persecution by the Nazis.','R-15','04-FEB-94',22000000,195);

INSERT INTO movi
VALUES('Pulp Fiction','The lives of two mob hitmen, a boxer, a gangsters wife, and a pair of diner bandits intertwine in four tales of violence and redemption.','R-18','09-DEC-94',8000000,154);
...
INSERT INTO mgenre
VALUES('Schindlers List','Biography');
...
INSERT INTO mprodcomp
VALUES('Schindlers List','Universal Pictures');
...
INSERT INTO tvshoW
VALUES ('The Orville','TV-14',7.9,'10-SEP-17','An exploratory ship from Earth faces intergalactic challenges 400 years in the future.');

INSERT INTO tvshow
VALUES ('The Umbrella Academy', 'TV-14',8.1,'15-FEB-19','A disbanded group of superheroes reunites after their adoptive father, who trained them to save the world, dies.');

INSERT INTO tvshoW
VALUES ('The Big Bang Theory', 'TV-14',8.2,'01-MAY-06','A woman who moves into an apartment across the hall from two brilliant but socially awkward physicists shows them how little they know about life outside of the laboratory.');
...
INSERT INTO episode
VALUES ('Hanna', 'Forest', 8.0, 48, 'After their wedding, Amy and Sheldon go on their honeymoon.', '24-SEP-18');
...
INSERT INTO episode
VALUES ('Santa Clarita Diet', 'Wuffenloaf', 8.2, 30, 'God, why me? Thats what Sheila wants to know. Meanwhile, Joel feels a smidge threatened, Anne spreads the gospel, and Abby and Eric pretend to date.', '29-MAR-19');
...
INSERT INTO actor
VALUES('Martin','Balsam','Martin Henry Balsam was born on November 4 1919 in the Bronx New York City to Lillian (Weinstein) and Albert Balsam, a manufacturer of womens sportswear.','04-NOV-19');
...
INSERT INTO actor
VALUES('Joey','K','Joey K started acting professionally when she was four years old. A national spot for Life Cereal was Joeys first commercial.','30-JUL-99');

INSERT INTO actor
VALUES('Drew','Barrymore','Since melting audiences hearts at the age of six in Steven Spielbergs beloved sci-fi blockbuster, E.T. the Extra-Terrestrial (1982), Drew Barrymore has emerged as one of the most endearing and talented actresses of her generation.','22-FEB-75');
...
INSERT INTO actedinm
VALUES('Liam','Neeson','Schindlers List');
...
INSERT INTO director
VALUES('Steven','Spielberg','One of the most influential personalities in the history of cinema, Steven Spielberg is Hollywoods best known director and one of the wealthiest filmmakers in the world.','18-DEC-46');
...
INSERT INTO director
VALUES('D','Benioff','David Benioff was born on September 25, 1970 in New York City, New York, USA as David Friedman. He is a writer and producer, known for Game of Thrones, and The Kite Runner','25-SEP-1970');
...
INSERT INTO director
VALUES('John','Hyams','Beginning his career in the fine arts, John Hyams graduated from Syracuse Universitys School of Visual and Performing Arts, earning top awards in painting and sculpture.','19-DEC-64');
...
INSERT INTO director
VALUES('Da','Farr','Da Farr was born in 1969 in Guildford, Surrey, England. He is a writer and producer, known for The Night Manager (2016), Hanna (2011) and Hanna (2019).','29-OCT-69');
...
INSERT INTO dir_m
VALUES('Steven','Spielberg','Schindlers List');
...
INSERT INTO dir_tv
VALUES('D','Benioff','Game of Thrones');
...
INSERT INTO dir_tv
VALUES('Bryan','Fuller','Star Trek: Discovery');
...
INSERT INTO actoraw
VALUES('Kiernan','Shipka','BTVA Peoples Choice Voice Acting Award');
...
INSERT INTO actoraw
VALUES('Norman','Reedus','IGNs People Choice Award');
...
INSERT INTO dawwon
VALUES('D','Benioff','Primetime Emmy');
...
INSERT INTO dawwon
VALUES('Da','Farr','British Screenwriters Award');
...
INSERT INTO afilm
VALUES('Martin','Balsam','All the Presidents Men, 12 Angry Men, A Thousand Clowns, Psycho');

INSERT INTO afilm
VALUES('Liam', 'Neeson','Kinsey, Schindlers List, The Grey, The A-Team');
...
INSERT INTO dfilm
VALUES('Sidney','Lumet','12 Angry Men, Dont Let the Devil Know You are Dead, Dog Day Afternoon, Murder on the Orient Express');

INSERT INTO dfilm
VALUES('Steven','Spielberg','Schindlers List, E.T. The Extraterrestrial, Saving Private Ryan, Indiana Jones and the Raiders of the Lost Ark');
